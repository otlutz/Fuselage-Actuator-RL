...
if __name__ == "__main__":
    ...
    for update in range(starting_update, num_updates + 1):
        ...
        if args.anneal_lr:
            ...
            stdnow = 1/np.sqrt(num_updates+1)
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                action, logprob, _, value = agent.get_action_and_value(next_obs, scaleStd=stdnow)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = agent.get_action_and_value(b_obs[mb_inds], b_actions[mb_inds], scaleStd=stdnow)
